...
# print(f'В вашей базе {len(cities_list)} городов')
#
# city_set = set()
#
...
#
#   if human_city not in city_set:
#     print("Человек проиграл. Такого города нет в базе")
#     break
#
#   if computer_city:
#     if human_city[0].lower() != computer_city[-1]:
#       print('Человек проиграл. Вы не соблюдаете правила игры')
#       break
#
#   city_set.remove(human_city)
#
#   for city in city_set:
#     if city[0].lower() == human_city[-1]:
#       computer_city = city
#       print(f'Компьютер: {computer_city}')
#       break
#
#   else:
#     print(f'Компьютер проиграл.')
#
#   city_set.remove(computer_city)


#другой вариант, который говорит города по txt
# import random
# import string
#
#
