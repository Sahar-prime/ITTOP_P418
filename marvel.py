...
#
# print("Выберите режим фильтрации:")
# print("1: По вхождению строки в название фильма")
# print("2: По конкретному году выпуска")
# print("3: Фильмы старше указанного года")
# print("4: Фильмы новее указанного года")
#
# mode = input("Введите номер режима: ")
#
# if mode not in ["1", "2", "3", "4"]:
#     print("Некорректный режим фильтрации.")
#     exit()
#
# filtered_movies = []
#
...
#     try:
#         year = int(year)
#         for movie, movie_year in small_dict.items():
#             if movie_year == year:
#                 filtered_movies.append(movie)
#     except ValueError:
...
#         year = int(year)
#         for movie, movie_year in small_dict.items():
#             if movie_year and movie_year < year:
#                 filtered_movies.append(movie)
#     except ValueError:
...
# else:
#     print("Фильмов, соответствующих критериям, не найдено.")
